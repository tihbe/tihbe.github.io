...
<figure>
  <img src="/figures/coin-fig1.png" alt="Probability of winning the coin-pair flip game for Bob and Alice" />
  <figcaption>Probability of winning the coin-pair flip game for Bob and Alice (N = 1,000,000 simulations).</figcaption>
</figure>
