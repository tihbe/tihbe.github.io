...
<figure>
  <img src="/figures/ev-hist.png" alt="Histograms of dataset columns: vehicle age, engine type, mileage, top 15 makes" />
  <figcaption>Histogram for each column of the dataset.</figcaption>
</figure>
...
<figure>
  <img src="/figures/ev-avg-price.png" alt="Average and median vehicle price by engine type and vehicle age" />
  <figcaption>Average and median vehicle price by engine type.</figcaption>
</figure>
...
<figure>
  <img src="/figures/ev-model-summary.png" alt="Mixed-effect regression model summary" />
  <figcaption>Mixed-effects model summary.</figcaption>
</figure>
