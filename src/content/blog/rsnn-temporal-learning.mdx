...
In this paper, we tackle one of the biggest limitations of training RSNNs with binary spikes — handling long temporal dependencies. Backpropagation through time becomes increasingly unstable in such settings, but we introduce three changes to overcome this:
...
We believe this work is a step toward making RSNNs more practical for neuromorphic hardware, both digital and analog.

Full article: [doi.org/10.1088/2634-4386/add293](https://doi.org/10.1088/2634-4386/add293)
