...
In this paper, we tackle one of the biggest limitations of training RSNNs with binary spikes, i.e., handling long temporal dependencies. Backpropagation through time becomes increasingly unstable in such settings, but we introduce three changes to overcome this:
...
Full article: <https://doi.org/10.1088/2634-4386/add293>
